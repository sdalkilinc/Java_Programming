...
public class ArrayUtilityMethods {
    public static void main(String[] args) {
        ...
        System.out.println(r2); //it gives false, because orders matter in arrays.

        String[] s1 = {"A", "B", "C"};
        String[] s2 = {"A", "C", "B"};

        System.out.println(Arrays.equals(s1,s2)); //it gives false, because orders matter in arrays.

        System.out.println("----------------------------------------");

        int[] nums = {100, 80, 90, 75, 88, 99};
