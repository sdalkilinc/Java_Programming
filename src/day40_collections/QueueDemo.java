...
public class QueueDemo {
    public static void main(String[] args) {
        ...
        Queue<Integer> queue3 = new LinkedList<>(); //insertion order, accepts null, has index number
        ...
        System.out.println(((LinkedList)queue3).get(4)); //get method works but need be casted to the LinkedList
