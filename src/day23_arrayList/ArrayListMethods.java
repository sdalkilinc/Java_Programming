...
public class ArrayListMethods {
    public static void main(String[] args) {
        ...
        // groceriesList[2] = "Orange";

        groceriesList.set(2, "Oranges"); //for replacing elements
        System.out.println(groceriesList);

        groceriesList.add(2, "Chicken"); //for adding new elements
        System.out.println(groceriesList);

        groceriesList.remove(0); //for removing the element by giving index number
        System.out.println(groceriesList);

        groceriesList.remove("paper towels"); //for removing the element by typing the element name
        System.out.println(groceriesList);
